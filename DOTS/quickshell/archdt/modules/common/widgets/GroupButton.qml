...
Button {
    ...
    property color colBackgroundToggled: Appearance?.colors.colPrimary ?? '#3b344f'
    property color colBackgroundToggledHover: Appearance?.colors.colPrimaryHover ?? '#3b344f'
