...
Singleton {
    ...
    property string shellConfig: FileUtils.trimFileProtocol(`${Directories.config}/archdt`)
    ...
    property string generatedMaterialThemePath: FileUtils.trimFileProtocol(`${Directories.genericCache}/wal/colors.json`) // tem que usar o template do end-4
